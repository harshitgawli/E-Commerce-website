...
const PlaceOrder = () => {
  ...
  const { navigate, cartItems, setCartItems, getCartAmout, shippingCost, products ,backendUrl ,token } = useContext(ShopContext);
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      let orderData = {
        address: formData,
        items: orderItems,
        amount: getCartAmout() + shippingCost
      }
    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-top'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-120'>
        ...
        <div className='flex  gap-3 '>
          ...
          <input required onChange={onChangeHandler} name='lastName' value={formData.lastName} className='border border-gray-400 rounded py-1.5 px-3.5 w-full' type="text" placeholder='Second Name' />
        ...
        <div className='flex  gap-3 '>
          <input required onChange={onChangeHandler} name='pinCode' value={formData.pinCode} className='border border-gray-400 rounded py-1.5 px-3.5 w-full' type="number" placeholder='PIN CODE' />
        ...
        <input required onChange={onChangeHandler} name='phone' value={formData.phone} className='border border-gray-400 rounded py-1.5 px-3.5 w-full' type="number" placeholder='Mobile Number' />
