            ...
            <div key={index} className='py-4 border-t border-b text-gray-700 flex  flex-col md:flex-row md:items-center md: justify-between gap-4'>
              <div className='flex items-start gap-6 text-sm'>
                ...
                <div>
                  ...
                  <p className='text-gray-500 text-sm mt-1'>DATE: <span className='font-semibold'>{new Date(item.date).toDateString()}</span></p>
                  <p className='text-gray-500 text-sm mt-1'>PAYMENT: <span className='font-semibold'>{item.paymentMethod}</span></p>
                </div>
              </div>
